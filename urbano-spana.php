...
<html lang="pt-br">
  <head>
    ...
    <title>Urbano Spaña | Apartamentos prontos para morar - SRF Incorporadora e Construtora</title>
  ...
  <body>
            ...
            <div class="banner-page" style="background:url(images/urbano-spana.jpg)">
              <div class="container">
                <nav>
                    <ol class="breadcrumb hidden-xs">
                      ...
                      <li class="breadcrumb-item">Urbano Spaña</li>
                    </ol>
                </nav>
                <h1>Urbano Spaña</h1>
              </div>
                  ...
                  <div class="row">
                      ...
                      <div class="col-sm-pull-5 col-md-pull-4 col-sm-7 col-md-8 page-content">
                            <div class="col-sm-6 col-md-5">
                              <img class="img-fluid" src="images/logo-spana-main.jpg">
                            </div>
