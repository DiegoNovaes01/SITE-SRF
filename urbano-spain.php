...
<html lang="pt-br">
  <head>
    ...
    <title>Urbano Spain | Apartamentos prontos para morar - SRF Incorporadora e Construtora</title>
  ...
  <body>
            ...
            <div class="banner-page" style="background:url(images/urbano-spain.jpg)">
              <div class="container">
                <nav>
                    <ol class="breadcrumb hidden-xs">
                      <li class="breadcrumb-item"><a href="https://www.srfincorporadora.com.br">Home</a></li>
                      <li class="breadcrumb-item"><a href="https://www.srfincorporadora.com.br/lancamento.php">Lançamento</a></li>
                      <li class="breadcrumb-item">Urbano Spain</li>
                    </ol>
                </nav>
                <h1>Urbano Spain</h1>
              </div>
                ...
                <div class="container">
                  <div class="grid-slider-65 margin-10">
                      ...
                      <div class="grid-slider-31">
                        ...
                        <h4>60,56 m², 57,23 m² e 61,27 m²</h4>
                      </div>
            ...
            <div class="container">
                  <div class="row">
                      <div class="col-sm-push-7 col-md-push-8 col-sm-5 col-md-4">
                        <div class="frm-orcamento-box">
                          ...
                          <form class="frm-orcamento formulario" id="frm-orcamento" name="form-orcamento" action="scripts/calltoacion.php"  method="post">
                            ...
                            <input type="hidden" id="" name="interesse" value="Urbano Italian">
                      ...
                      <div class="col-sm-pull-5 col-md-pull-4 col-sm-7 col-md-8 page-content">
                            <div class="col-sm-6 col-md-5">
                              <img class="img-fluid" src="images/logo-spain-main.jpg">
                            </div>
                            <div class="col-sm-6 col-md-6 ficha-tecnica">
                              <h2>Ficha técnica</h2>
                              <ul>
                                <li>• Número de Torres: 1</li>
                                <li>• Unidades por Andar: 6 apartamentos</li>
                                <li>• Número de Pavimentos: 14 pavimentos</li>
                                <li>• Número de Elevadores: 2 elevadores</li>
                                <li>• Total de Unidades: 84 apartamentos</li>
                                <li>• Estacionamento: 1 vaga</li>
                                <li>• Status atual: Lançamento</li>
                              </ul>
                            </div>
                      </div>
                  </div>
                  ...
                  <div class="row">
          						<div class="col-sm-12 col-md-12">
                                    ...
                                    <li class="nav-item">
                    										<a class="nav-link" href="#tour" data-toggle="tab">TOUR 360º</a>
                  									</li>
                                    <li class="nav-item">
                    										<a class="nav-link" href="#decorado" data-toggle="tab">DECORADO</a>
                  									</li>
              								</ul>
                              <div class="clearfix"></div>
                                              ...
                                              <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                                                ...
                                                <div class="carousel-inner" role="listbox">
                                                    <div class="item active">
                                                         <img src="images/urbano-italian/italian-lazer-fachada.jpg" class="img-responsive" alt="Fachada">
                                                         <div class="carousel-caption">
                                                           <h2>Fachada</h2>
                                                         </div>
                                                    </div>
                                                    <div class="item">
                                                          <img src="images/urbano-italian/italian-lazer-churrasqueira.jpg" class="img-responsive" alt="Churrasqueira">
                                                          <div class="carousel-caption">
                                                            <h2>Churasqueira</h2>
                                                          </div>
                                                    </div>
                                                    <div class="item">
                                                         <img src="images/urbano-italian/italian-lazer-brinquedoteca.jpg" class="img-responsive" alt="Brinquedoteca">
                                                         <div class="carousel-caption">
                                                           <h2>Brinquedoteca</h2>
                                                         </div>
                                                    </div>
                                                    <div class="item">
                                                         <img src="images/urbano-italian/italian-lazer-praca-convivio.jpg" class="img-responsive" alt="Praça de convívio">
                                                         <div class="carousel-caption">
                                                           <h2>Praça de convívio</h2>
                                                         </div>
                                                    </div>
                                                    <div class="item">
                                                         <img src="images/urbano-italian/italian-lazer-praca-jogos.jpg" class="img-responsive" alt="Praça de jogos">
                                                         <div class="carousel-caption">
                                                           <h2>Praça de jogos</h2>
                                                         </div>
                                                    </div>
                                                    <div class="item">
                                                         <img src="images/urbano-italian/italian-lazer-fitness.jpg" class="img-responsive" alt="Fitness">
                                                         <div class="carousel-caption">
                                                           <h2>Fitness</h2>
                                                         </div>
                                                    </div>
                                                    <div class="item">
                                                         <img src="images/urbano-italian/italian-lazer-piscina.jpg" class="img-responsive" alt="Piscina adulto e infantil">
                                                         <div class="carousel-caption">
                                                           <h2>Piscina adulto e infantil</h2>
                                                         </div>
                                                    </div>
                                                    <div class="item">
                                                         <img src="images/urbano-italian/italian-lazer-playground.jpg" class="img-responsive" alt="Playground">
                                                         <div class="carousel-caption">
                                                           <h2>Playground</h2>
                                                         </div>
                                                    </div>
                                                    <div class="item">
                                                         <img src="images/urbano-italian/italian-lazer-salao-de-festas.jpg" class="img-responsive" alt="Sala">
                                                         <div class="carousel-caption">
                                                           <h2>Salão de festas</h2>
                                                         </div>
                                                    </div>
                                                    <div class="item">
                                                         <img src="images/urbano-italian/italian-lazer-gourmet.jpg" class="img-responsive" alt="Sala">
                                                         <div class="carousel-caption">
                                                           <h2>Gourmet</h2>
                                                         </div>
                                                    </div>
                                                    <div class="item">
                                                          <img src="images/urbano-italian/italian-lazer-brinquedoteca.jpg" class="img-responsive" alt="Salão de festas">
                                                          <div class="carousel-caption">
                                                            <h2>Brinquedoteca</h2>
                                                          </div>
                                                    </div>
                                                    <div class="item">
                                                          <img src="images/urbano-italian/italian-lazer-mulher.jpg" class="img-responsive" alt="Salão de festas">
                                                          <div class="carousel-caption">
                                                            <h2>Espaço Mulher</h2>
                                                          </div>
                                                    </div>
                                                    <div class="item">
                                                          <img src="images/urbano-italian/italian-lazer-espaco-teen.jpg" class="img-responsive" alt="Espaço Teen">
                                                          <div class="carousel-caption">
                                                            <h2>Espaço Teen</h2>
                                                          </div>
                                                    </div>
                                                    <div class="item">
                                                          <img src="images/urbano-italian/italian-lazer-portaria.jpg" class="img-responsive" alt="Portaria 24 horas">
                                                          <div class="carousel-caption">
                                                            <h2>Portaria 24 horas</h2>
                                                          </div>
                                                    </div>
                                              </div>
                                      ...
                                      <div class="slider-banners">
                                            <div id="carousel-apartamento" class="carousel slide" data-ride="carousel">
                                              ...
                                              <ol class="carousel-indicators">
                                                ...
                                                <li data-target="#carousel-apartamento" data-slide-to="2"></li>
                                              </ol>
                                              <!-- Wrapper for slides -->
                                              <div class="carousel-inner" role="listbox">
                                                   <div class="item active">
                                                        <img src="images/urbano-italian/italian-living.jpg" class="img-responsive" alt="Sala">
                                                        <div class="carousel-caption">
                                                          <h2>Living</h2>
                                                        </div>
                                                   </div>
                                                   <div class="item">
                                                       <img src="images/urbano-italian/italian-sacada.jpg" class="img-responsive" alt="Fachada Urbano Armenian">
                                                        <div class="carousel-caption">
                                                          <h2>Sacada</h2>
                                                        </div>
                                                   </div>
                                                   <div class="item">
                                                       <img src="images/urbano-italian/italian-quarto.jpg" class="img-responsive" alt="Fachada Urbano Armenian">
                                                        <div class="carousel-caption">
                                                          <h2>Quarto</h2>
                                                        </div>
                                                   </div>
                                      ...
                                      <div id="apartamento" class="tab-pane">
                                        <div class="slider-banners">
                                              <div id="carousel-planta" class="carousel slide" data-ride="carousel">
                                                ...
                                                <div class="carousel-inner" role="listbox">
                                                     <div class="item active">
                                                          <img src="images/urbano-italian/italian-planta-1.jpg" class="img-responsive" alt="Sala">
                                                          <div class="carousel-caption">
                                                            <h2>Planta tipo 1 - 48,34m² (2 dorms)</h2>
                                                          </div>
                                                     </div>
                                                     <div class="item">
                                                         <img src="images/urbano-italian/italian-planta-2.jpg" class="img-responsive" alt="Fachada Urbano Armenian">
                                                          <div class="carousel-caption">
                                                            <h2>Planta tipo 2 - 46,14 m² (2 dorms)</h2>
                                                          </div>
                                                     </div>
                                              </div>
                                    ...
                                    <div id="tour" class="tab-pane">
                                      <iframe class="tour" src="https://www.3dexplora.com.br/seutour.aspx?codigo=Tco34dSspBg&play=-1&hl=0&qs=0&wh=0&lp=0&ts=1" frameborder="0" allowfullscreen></iframe>

                  									</div>

                                    <!-- final apto-->

                                    <div id="decorado" class="tab-pane">
                                      <div id="apartamento" class="tab-pane">
                                        <div class="slider-banners">
                                              <div id="carousel-decorado" class="carousel slide" data-ride="carousel">
                                                <!-- Indicators -->
                                                <ol class="carousel-indicators">
                                                  <li data-target="#carousel-decorado" data-slide-to="0" class="active"></li>
                                                  <li data-target="#carousel-decorado" data-slide-to="1"></li>
                                                  <li data-target="#carousel-decorado" data-slide-to="2"></li>
                                                </ol>
                                                <!-- Wrapper for slides -->
                                                <div class="carousel-inner" role="listbox">
                                                     <div class="item active">
                                                          <img src="images/urbano-italian/italian-decorado-1.jpg" class="img-responsive" alt="Sala">
                                                          <div class="carousel-caption">
                                                            <h2>Living</h2>
                                                          </div>
                                                     </div>
                                                     <div class="item">
                                                         <img src="images/urbano-italian/italian-decorado-2.jpg" class="img-responsive" alt="Jantar">
                                                          <div class="carousel-caption">
                                                            <h2>Sala de jantar</h2>
                                                          </div>
                                                     </div>
                                                     <div class="item">
                                                         <img src="images/urbano-italian/italian-decorado-5.jpg" class="img-responsive" alt="Cozinha">
                                                          <div class="carousel-caption">
                                                            <h2>Cozinha</h2>
                                                          </div>
                                                     </div>
                                                     <div class="item">
                                                         <img src="images/urbano-italian/italian-decorado-6.jpg" class="img-responsive" alt="Lavanderia">
                                                          <div class="carousel-caption">
                                                            <h2>Lavanderia</h2>
                                                          </div>
                                                     </div>
                                                     <div class="item">
                                                         <img src="images/urbano-italian/italian-decorado-3.jpg" class="img-responsive" alt="Quarto casal">
                                                          <div class="carousel-caption">
                                                            <h2>Quarto casal</h2>
                                                          </div>
                                                     </div>
                                                     <div class="item">
                                                         <img src="images/urbano-italian/italian-decorado-7.jpg" class="img-responsive" alt="Banheiro">
                                                          <div class="carousel-caption">
                                                            <h2>Banheiro</h2>
                                                          </div>
                                                     </div>
                                                     <div class="item">
                                                         <img src="images/urbano-italian/italian-decorado-4.jpg" class="img-responsive" alt="Quarto solteiro">
                                                          <div class="carousel-caption">
                                                            <h2>Quarto solteiro</h2>
                                                          </div>
                                                     </div>
                                              </div>
                                              <a class="left carousel-control" href="#carousel-decorado" data-slide="prev">
                                                  <span class="glyphicon glyphicon-chevron-left"></span>
                                                  <span class="sr-only">anterior</span>
                                              </a>
                                              <a class="right carousel-control" href="#carousel-decorado" data-slide="next">
                                                  <span class="glyphicon glyphicon-chevron-right"></span>
                                                  <span class="sr-only">Próximo</span>
                                              </a>
                                          </div>
              ...
              <div class="container">
                <div class="row">
                      <div class="col-sm-12 col-md-12 abre-destaques">
                        ...
                        <p>Conheça apartamento decorado: Rua Lourenço Collino 271, Presidente Altino - Osasco-SP</p>
                      </div>
                </div>
              </div>
    ...
    <?php include("destaque-misto.php"); ?>
